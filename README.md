...
As a first step in creatign this model, in order to get a better understandign of the data, EDA was conducted and a visualization was produced using Matplotlib and Seaborn.
